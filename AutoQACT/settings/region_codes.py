...
palliative_thorax_codes = list(range(30, 43+1)) + list(range(200, 223+1)) + list(range(231, 238+1)) + list(range(251, 258+1)) + list(range(417, 419+1)) + list(range(518, 521+1)) + list(range(530, 538+1))
...
palliative_pelvis_codes = list(range(70, 85+1)) +list(range(342, 349+1)) + list(range(353, 354+1)) + list(range(512, 514+1)) + list(range(524, 527+1)) + list(range(541, 546+1))
