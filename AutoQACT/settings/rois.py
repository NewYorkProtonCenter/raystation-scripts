...
# YW HN
ctv1 = ROI.ROI('CTV_6600', 'Ctv', COLORS.ctv_high)
ctv2 = ROI.ROI('CTV_6006', 'Ctv', COLORS.ctv_med)
ctv3 = ROI.ROI('CTV_5412', 'Ctv', COLORS.ctv_low)
...
# Head:
eye_l = ROI.ROI('Eye_L', 'Organ', COLORS.eye_l)
eye_r = ROI.ROI('Eye_R', 'Organ', COLORS.eye_r)
...
optic_nrv_r = ROI.ROI('OpticNerve_R', 'Organ', COLORS.optic_nrv_r)
optic_chiasm = ROI.ROI('OpticChiasm','Organ', COLORS.chiasm)
lacrimal_l =ROI.ROI('Glnd_Lacrinal_R', 'Organ', COLORS.lacrimal_r)
lacrimal_r =ROI.ROI('Glnd_Lacrinal_L', 'Organ', COLORS.lacrimal_l)
cochlea_l = ROI.ROI('Cochlea_L','Organ', COLORS.cochlea_l)
cochlea_r = ROI.ROI('Cochlea_R','Organ', COLORS.cochlea_r)
...
submand_l = ROI.ROI('Glnd_Submand_L', 'Organ', COLORS.submand_l)
submand_r = ROI.ROI('Glnd_Submand_R', 'Organ', COLORS.submand_r)
larynx = ROI.ROI('Larynx', 'Organ', COLORS.larynx)
parotid_l = ROI.ROI('Parotid_L', 'Organ', COLORS.parotid_l)
parotid_r = ROI.ROI('Parotid_R', 'Organ', COLORS.parotid_r)
mandible = ROI.ROI('Bone_Mandible', 'Organ', COLORS.mandible)
pharynx = ROI.ROI('Pharynx', 'Organ', COLORS.pharynx)
# Thorax:
esophagus = ROI.ROI('Esophagus', 'Organ', COLORS.esophagus)
spinal_cord = ROI.ROI('SpinalCord', 'Organ', COLORS.spinal_cord)
spinal_cord_05 = ROI.ROI('SpinalCord_05', 'Organ', COLORS.spinal_cord_05)
...
imn = ROI.ROI('LN_IMN', 'Undefined', COLORS.imn)
...
skin_brain = ROI.ROIWall('Skin','Organ', COLORS.skin, body, 0, 0.3)
...
# YW
# z_ctv2_hot_draft = ROI.ROIAlgebra('z_ctv2_hot_draft', 'Undefined', COLORS.contralat, sourcesA = [ctv_med], sourcesB = [ctv], operator = 'Intersection', marginsA = MARGINS.zero, marginsB = MARGINS.uniform_5mm_contraction)
z_ctv2_hot_draft = ROI.ROIAlgebra('z_ctv2_hot_draft', 'Undefined', COLORS.contralat, sourcesA = [ctv2], sourcesB = [ctv], operator = 'Intersection', marginsA = MARGINS.zero, marginsB = MARGINS.uniform_5mm_contraction)
...
z_ptv_57_60_wall = ROI.ROI('zPTV_57_60_Wall', 'Undefined', COLORS.wall)
...
box = ROI.ROI('Box','Undefined', COLORS.mask_ptv)
