...
from rt_classes.margin import Contraction, Expansion
...
class ROIAlgebra(object):
    ...
    def __init__(self, name, type, color, sourcesA=[], sourcesB=[], operator='Union', operatorA='Union', operatorB='Union',
                 marginsA: Union[Expansion, Contraction]=MARGINS.zero,
                 marginsB: Union[Expansion, Contraction]=MARGINS.zero,
                 result_margins: Union[Expansion, Contraction]=MARGINS.zero):
        self.name = name
        self.type = type
        self.color = color
