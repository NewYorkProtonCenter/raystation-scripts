...
from System.Windows.Forms import (BorderStyle, Button, DialogResult, Form, FormBorderStyle, Label, Panel, TextBox)  # type: ignore
...
class FractionationForm(Form):
    ...
    def setupRegionCode( self):
        ...
        self.regionCodeLabel1.Text = "Region code:"
    ...
    def setupFractionDoseCode( self):
        ...
        self.fractionDoseLabel1.Text = "Fractional dose [Gy]:"
    ...
    def setupNumberOfFractions( self):
        ...
        self.numberFractionsLabel1.Text = "Number of fractions:"
    ...
    def setupPlannerInitials( self):
        ...
        self.plannerInitialsLabel1.Text = "Dose planner initials:"
